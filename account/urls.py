...
from .views import RegistrationView,ActivateUser,LoginView,LogoutVeiw,UserdetailView,ChangePasswordView,UserdeleteView,ResetpasswordView,ConformResetPasswordView,GetCSRFToken
